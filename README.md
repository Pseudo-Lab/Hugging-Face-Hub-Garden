...
| 2025/03/20 | 데이터 수집 | 데이터 수집 및 생성 기법 소개 |  |  
| 2025/03/27 | **✨ Magical Week ✨** |  |  |  
| 2025/04/03 | 데이터셋 품질 검증 및 강화 | 고품질 데이터셋 구축 방법론<br>(데이터셋 카드 참고) |  |  
| 2025/04/10 | Hugging Face 데이터셋 카드 작성 | Hugging Face 데이터셋 카드 가이드<br>Hugging Face 모델 허브 탐색법 |  |  
| 2025/04/17 | 모델 탐색 1차 | 모델 성능 평가 방법론 |  |  
| 2025/04/24 | **✨ Magical Week ✨** |  |  |  
| 2025/05/01 | 모델 파인 튜닝 및 최적화 | 효율적인 모델 파인 튜닝 전략 |  |  
| 2025/05/08 | 프로젝트 중간 점검 및 논의<br>(성능 분석 및 피드백)|  |  |  
| 2025/05/15 | 최종 모델 및 데이터셋 업로드 | Hugging Face 모델 카드 작성 가이드 |  |  
| 2025/05/17 | **수도콘 발표** |  |  |  
| 2025/05/22 | Hugging Face Space 데모 애플리케이션 구현 | Hugging Face Spaces 가이드 |  |  
| 2025/05/29 | 가이드북 및 블로그 작성 | 자유 주제 |  |  
| 2025/06/05 | 가이드북 및 블로그 작성 | 자유 주제 |  |  
