...
| 2025/05/17 | **수도콘 발표** |  |  |  
| 2025/05/22 | 최종 모델 및 데이터셋 업로드 | Hugging Face 모델 카드 작성 가이드 | 조영준 |  
| 2025/05/29 | Hugging Face Space 데모 애플리케이션 구현 | Hugging Face Spaces 가이드 | 정재윤 |  
| 2025/06/05 | 가이드북 및 블로그 작성 | Gradio와 MCP | 김하림 |  
